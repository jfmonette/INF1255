...
'''
Les fonctions sont définies par trois composantes :

1. La signature
   La signature, qui inclut : le mot-clé 'def', le nom de la fonction et les paramètres de celle-ci (il peut ne pas y avoir de paramètre).
2. Un commentaire (optionnel)
   Le commentaire explique l'intention de la fonction.
